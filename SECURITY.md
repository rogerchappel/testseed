...
Replace this section with the supported versions for `testseed`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `testseed` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in testseed.
